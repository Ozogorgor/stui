...
impl RpcResponse {
    pub fn ok(id: impl Into<String>, result: Value) -> Self {
        RpcResponse { id: id.into(), result: Some(result), error: None }
    }
...
pub struct RpcMediaItem {
    pub id:          String,
    pub title:       String,
    #[serde(default)] pub year:        Option<String>,
...
pub struct RpcStream {
    ...
    #[serde(default)] pub bitrate_kbps:  Option<u32>,
    /// Torrent swarm size at resolution time.
    #[serde(default)] pub seeders:       Option<u32>,
    /// Video codec, e.g. `"H264"`, `"HEVC"`, `"AV1"`.
    #[serde(default)] pub codec:         Option<String>,
    ...
    #[serde(default)] pub hdr:           Option<crate::providers::HdrFormat>,
    /// Approximate file size in bytes.
    #[serde(default)] pub size_bytes:    Option<u64>,
    /// Audio channel layout, e.g. `"5.1"`, `"7.1 Atmos"`.
    #[serde(default)] pub audio_channels: Option<String>,
