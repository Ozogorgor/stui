...
mod tests {
    ...
    #[test]
    fn plain_year() {
        assert_eq!(extract_year("2017"), "2017");
    }
    #[test]
    fn iso_date() {
        assert_eq!(extract_year("2017-05-03"), "2017");
    }
    #[test]
    fn month_year() {
        assert_eq!(extract_year("May 2017"), "2017");
    }
    #[test]
    fn dmy() {
        assert_eq!(extract_year("03-05-2017"), "2017");
    }
    #[test]
    fn empty() {
    ...
    #[test]
    fn two_digit_year() {
        assert_eq!(extract_year("03-05-19"), "");
    }
    #[test]
    fn junk() {
        assert_eq!(extract_year("not a date"), "");
    }
    #[test]
    fn year_out_of_range() {
        assert_eq!(extract_year("3500"), "");
    }
    #[test]
    fn first_match_wins() {
        assert_eq!(extract_year("1999 or 2001?"), "1999");
    }
    #[test]
    fn compact_date() {
        assert_eq!(extract_year("20170503"), "2017");
    }
}
