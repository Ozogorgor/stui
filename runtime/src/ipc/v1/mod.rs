...
pub struct ProviderField {
    /// Config key path, e.g. `"api_keys.tmdb"`.
    pub key:        String,
...
impl GridUpdateEvent {
    ...
    pub fn to_wire(&self) -> anyhow::Result<String> {
        ...
        map.insert("type".to_string(), serde_json::Value::String("grid_update".to_string()));
        map.insert("tab".to_string(), serde_json::Value::String(self.tab.clone()));
...
impl MediaTab {
    ...
    pub fn default_tabs() -> &'static [MediaTab] {
        &[MediaTab::Movies, MediaTab::Series, MediaTab::Music, MediaTab::Library]
    }
}
...
impl Response {
    ...
    pub fn error(id: Option<String>, code: ErrorCode, msg: impl Into<String>) -> Self {
        Response::Error(ErrorResponse { id, code, message: msg.into() })
    }
}
